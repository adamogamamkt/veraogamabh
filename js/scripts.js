...
// HEADER PÁGINAS
document.addEventListener("DOMContentLoaded", function() {
  fetch('header_combos.html')
      .then(response => response.text())
      .then(data => {
          document.getElementById('header-combos').innerHTML = data;
      });
  });
...
// TABELA SC JOHNSON OURO MG
document.addEventListener("DOMContentLoaded", function() {
  // URL do arquivo txt
  var txtFile = 'dados/dados_scjohnson_ouro_mg.txt';
  ...
  xhr.onload = function() {
    if (xhr.status === 200) {
      ...
      // Divide o texto em linhas (cada linha é separada por uma nova linha)
      var lines = txtData.split('\n');
      var tableBody = document.querySelector("#dados_scjohnson_ouro_mg tbody");
...
// TABELA SC JOHNSON PRATA MG
document.addEventListener("DOMContentLoaded", function() {
  // URL do arquivo txt
  var txtFile = 'dados/dados_scjohnson_prata_mg.txt';
  ...
  xhr.onload = function() {
    if (xhr.status === 200) {
      ...
      // Divide o texto em linhas (cada linha é separada por uma nova linha)
      var lines = txtData.split('\n');
      var tableBody = document.querySelector("#dados_scjohnson_prata_mg tbody");
...
// TABELA SC JOHNSON OURO BA
document.addEventListener("DOMContentLoaded", function() {
  // URL do arquivo txt
  var txtFile = 'dados/dados_scjohnson_ouro_ba.txt';
  ...
  xhr.onload = function() {
    if (xhr.status === 200) {
      ...
      // Divide o texto em linhas (cada linha é separada por uma nova linha)
      var lines = txtData.split('\n');
      var tableBody = document.querySelector("#dados_scjohnson_ouro_ba tbody");
...
// TABELA SC JOHNSON PRATA BA
document.addEventListener("DOMContentLoaded", function() {
  // URL do arquivo txt
  var txtFile = 'dados/dados_scjohnson_prata_ba.txt';
  ...
  xhr.onload = function() {
    if (xhr.status === 200) {
      ...
      // Divide o texto em linhas (cada linha é separada por uma nova linha)
      var lines = txtData.split('\n');
      var tableBody = document.querySelector("#dados_scjohnson_prata_ba tbody");
...
// TABELA SC JOHNSON OURO RJ
document.addEventListener("DOMContentLoaded", function() {
  // URL do arquivo txt
  var txtFile = 'dados/dados_scjohnson_ouro_rj.txt';
  ...
  xhr.onload = function() {
    if (xhr.status === 200) {
      ...
      // Divide o texto em linhas (cada linha é separada por uma nova linha)
      var lines = txtData.split('\n');
      var tableBody = document.querySelector("#dados_scjohnson_ouro_rj tbody");
...
// TABELA SC JOHNSON PRATA RJ
document.addEventListener("DOMContentLoaded", function() {
  // URL do arquivo txt
  var txtFile = 'dados/dados_scjohnson_prata_rj.txt';
  ...
  xhr.onload = function() {
    if (xhr.status === 200) {
      ...
      // Divide o texto em linhas (cada linha é separada por uma nova linha)
      var lines = txtData.split('\n');
      var tableBody = document.querySelector("#dados_scjohnson_prata_rj tbody");
...
// TABELA SC JOHNSON OURO ES
document.addEventListener("DOMContentLoaded", function() {
  // URL do arquivo txt
  var txtFile = 'dados/dados_scjohnson_ouro_es.txt';
  ...
  xhr.onload = function() {
    if (xhr.status === 200) {
      ...
      // Divide o texto em linhas (cada linha é separada por uma nova linha)
      var lines = txtData.split('\n');
      var tableBody = document.querySelector("#dados_scjohnson_ouro_es tbody");
...
// TABELA SC JOHNSON PRATA ES
document.addEventListener("DOMContentLoaded", function() {
  // URL do arquivo txt
  var txtFile = 'dados/dados_scjohnson_prata_es.txt';
  ...
  xhr.onload = function() {
    if (xhr.status === 200) {
      ...
      // Divide o texto em linhas (cada linha é separada por uma nova linha)
      var lines = txtData.split('\n');
      var tableBody = document.querySelector("#dados_scjohnson_prata_es tbody");
